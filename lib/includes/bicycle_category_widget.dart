...
class BicycleCategoryListWidget extends StatefulWidget {
  final String? category;

  const BicycleCategoryListWidget({Key? key, this.category}) : super(key: key);
  @override
  State<StatefulWidget> createState() {
    return _ShopListState();
  }
}
class _ShopListState extends State<BicycleCategoryListWidget> {
  ...
  Future refreshBicycles() async {
    ...
    this.bicycles = await BicyclesDatabase.instance.readWithCategory(widget.category!);
  ...
  Widget build(BuildContext context) {
    if(bicycles.length == 0){
      return Center(child: Text("No Bicycles in this category yet"));
    }else{
