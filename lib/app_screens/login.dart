        ...
        child: ListView(
          children: <Widget>[
            ...
            Container(
              ...
              child: Column(
                children: <Widget>[
                  // Text(widget.error, style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold),),
                  Form(
                    key: _formKey,
                    child: Container(
                  ...
                  InkWell(
                    onTap: () async{
                      ...
                      if(isValid){
                        UserDatabase.instance.readLoginData(_emailTextController.text, _passwordTextController.text, context);
